classdef rectangular_uniform_ground_plane
    ...
    methods
        ...
        % Methods for rectangular aperture, uniform ground plane
        function obj = rectangular_uniform_ground_plane(width, height, frequency, r, theta, phi)
            % Class constructor
            if(nargin > 0)
                obj.r = r;
                obj.theta = theta;
        ...
        function [e_r, e_theta, e_phi, h_r, h_theta, h_phi] = far_fields(obj)
            ...
            e_theta = 1j * obj.width * obj.height * k / (2.0 * pi * obj.r) * exp(-1j * k * obj.r) * sin(obj.phi) .* ...
            ...
            e_phi = 1j * obj.width * obj.height * k / (2.0 * pi * obj.r) * exp(-1j * k * obj.r) .* cos(obj.theta) .* cos(obj.phi) .* ...
                sinc(k * obj.width * 0.5 .* sin(obj.theta) .* cos(obj.phi)) .* sinc(k * obj.height * 0.5 * sin(obj.theta) .* sin(obj.phi));
            ...
            h_theta = -1j * obj.width * obj.height * k / (2.0 * pi * eta * obj.r) * exp(-1j * k * obj.r) .* cos(obj.theta) .* cos(obj.phi) .* ...
                sinc(k * obj.width * 0.5 .* sin(obj.theta) .* cos(obj.phi)) .* sinc(k * obj.height * 0.5 .* sin(obj.theta) .* sin(obj.phi));
            
            % Define the phi-component of the magnetic far field (A/m)
            h_phi = 1j * obj.width * obj.height * k / (2.0 * pi * eta * obj.r) * exp(-1j * k * obj.r) .* sin(obj.phi) .* ...
                sinc(k * obj.width * 0.5 .* sin(obj.theta) .* cos(obj.phi)) .* sinc(k * obj.height * 0.5 .* sin(obj.theta) .* sin(obj.phi));
        end
