...
# Form implementation generated from reading ui file 'Chapter08\StretchProcessor.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.window_type.addItem("")
        self.window_type.addItem("")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.window_type)
        self.range_window_length = QtWidgets.QLineEdit(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.range_window_length.sizePolicy().hasHeightForWidth())
        self.range_window_length.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.range_window_length.setFont(font)
        self.range_window_length.setObjectName("range_window_length")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.range_window_length)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Stretch Processor"))
        ...
        self.pulsewidth.setText(_translate("MainWindow", "10e-4"))
        self.label_3.setText(_translate("MainWindow", "Target Range (m)"))
        self.target_range.setText(_translate("MainWindow", "5, 15"))
        self.label.setText(_translate("MainWindow", "Target RCS (m^2)"))
        self.target_rcs.setText(_translate("MainWindow", "20, 10"))
        ...
        self.range_window_length.setText(_translate("MainWindow", "50.0"))
        self.label_4.setText(_translate("MainWindow", "Range Window (m)"))
