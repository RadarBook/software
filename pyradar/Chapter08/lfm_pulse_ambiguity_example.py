"""
Project: RadarBook
File: lfm_pulse_ambiguity_example.py
...
"""
import sys
from Chapter08.ui.AF_LFM_ui import Ui_MainWindow
...
class LFMPulse(QMainWindow, Ui_MainWindow):
    ...
    def _update_canvas(self):
        ...
        self.axes1.set_title('LFM Pulse Ambiguity Function', size=14)
...
def start(parent):
    form = LFMPulse(parent)  # Set the form
    form.show()        # Show the form


def main():
    app = QApplication(sys.argv)  # A new instance of QApplication
    form = LFMPulse()             # Set the form
    form.show()                   # Show the form
