...
# Form implementation generated from reading ui file 'Chapter04\OvalsOfCassini.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.separation_distance = QtWidgets.QLineEdit(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.separation_distance.sizePolicy().hasHeightForWidth())
        self.separation_distance.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.separation_distance.setFont(font)
        self.separation_distance.setObjectName("separation_distance")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.separation_distance)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.system_temperature)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.bandwidth)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.noise_figure)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.transmit_losses)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.receive_losses)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.peak_power)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.transmit_antenna_gain)
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.receive_antenna_gain)
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.frequency)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.FieldRole, self.bistatic_target_rcs)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.separation_distance.setText(_translate("MainWindow", "60"))
        ...
        self.receive_losses.setText(_translate("MainWindow", "3"))
        self.label_8.setText(_translate("MainWindow", "Peak Power (W)"))
        self.peak_power.setText(_translate("MainWindow", "100.0e3"))
        self.label_9.setText(_translate("MainWindow", "Transmit Antenna Gain (dB)"))
        self.transmit_antenna_gain.setText(_translate("MainWindow", "30.0"))
        self.label_12.setText(_translate("MainWindow", "Receive Antenna Gain (dB)"))
        self.receive_antenna_gain.setText(_translate("MainWindow", "30.0"))
