"""
Project: Radarbook
File: rounded_nose_cone_example.py
...
"""
import sys
from Chapter07.ui.RoundedNoseCone_ui import Ui_MainWindow
...
class RoundCone(QMainWindow, Ui_MainWindow):
    ...
    def _update_canvas(self):
        ...
        # Display the results
        self.axes1.plot(degrees(incident_angle), 10.0 * log10(abs(rcs)), '')
...
def start(parent):
    form = RoundCone(parent)  # Set the form
    form.show()         # Show the form


def main():
    app = QApplication(sys.argv)  # A new instance of QApplication
    form = RoundCone()            # Set the form
    form.show()                   # Show the form
