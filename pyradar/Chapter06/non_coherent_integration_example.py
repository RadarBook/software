"""
Project: RadarBook
File: non_coherent_integration_example.py
...
"""
import sys
from Chapter06.ui.NonCoherentPd_ui import Ui_MainWindow
...
class NonCoherentPd(QMainWindow, Ui_MainWindow):
    ...
    def _update_canvas(self):
        ...
        self.axes1.set_title('Noncoherent Integration', size=14)
...
def start(parent):
    form = NonCoherentPd(parent)  # Set the form
    form.show()             # Show the form


def main():
    app = QApplication(sys.argv)  # A new instance of QApplication
    form = NonCoherentPd()        # Set the form
    form.show()                   # Show the form
