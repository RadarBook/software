"""
Project: RadarBook
File: rayleigh_noise_pd_example.py
...
"""
import sys
from Chapter06.ui.RayleighNoisePd_ui import Ui_MainWindow
...
class RayleighNoisePd(QMainWindow, Ui_MainWindow):
    ...
    def _update_canvas(self):
        ...
        self.axes1.set_title('Pd - Rayleigh Noise', size=14)
...
def start(parent):
    form = RayleighNoisePd(parent)  # Set the form
    form.show()               # Show the form


def main():
    app = QApplication(sys.argv)  # A new instance of QApplication
    form = RayleighNoisePd()      # Set the form
    form.show()                   # Show the form
