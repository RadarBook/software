"""
Project: RadarBook
File: kalman_epsilon_example.py
...
"""
import sys
from Chapter09.ui.KalmanAdaptiveEpsilon_ui import Ui_MainWindow
...
class KalmanAdaptive(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.threshold.returnPressed.connect(self._update_canvas)
...
def start(parent):
    form = KalmanAdaptive(parent)  # Set the form
