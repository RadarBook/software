...
# Form implementation generated from reading ui file 'Chapter09\KalmanAcceleration.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.acceleration = QtWidgets.QLineEdit(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.acceleration.setFont(font)
        self.acceleration.setObjectName("acceleration")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.acceleration)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.measurement_noise_variance)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.process_noise_variance)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Initial Acceleration (x, y, z) (m/s/s)"))
        self.acceleration.setText(_translate("MainWindow", "0.5, 1.0, 0.75"))
        ...
        self.label_3.setText(_translate("MainWindow", "Process Noise Variance (m^2, (m/s)^2, (m/s/s)^2)"))
        ...
        self.plot_type.setItemText(6, _translate("MainWindow", "Acceleration - X"))
        self.plot_type.setItemText(7, _translate("MainWindow", "Acceleration - Y"))
        self.plot_type.setItemText(8, _translate("MainWindow", "Acceleration - Z"))
        self.plot_type.setItemText(9, _translate("MainWindow", "Residual"))
