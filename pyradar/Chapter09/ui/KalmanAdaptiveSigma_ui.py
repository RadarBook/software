...
# Form implementation generated from reading ui file 'Chapter09\KalmanAdaptiveSigma.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.initial_position)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.initial_velocity)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.measurement_noise_variance)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.process_noise_variance)
        ...
        self.plot_type.addItem("")
        self.plot_type.addItem("")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.plot_type)
        self.n_sigma = QtWidgets.QLineEdit(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.n_sigma.setFont(font)
        self.n_sigma.setObjectName("n_sigma")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.n_sigma)
        self.scale = QtWidgets.QLineEdit(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.scale.setFont(font)
        self.scale.setObjectName("scale")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.scale)
        ...
        self.maneuver_time = QtWidgets.QLineEdit(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.maneuver_time.setFont(font)
        self.maneuver_time.setObjectName("maneuver_time")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.maneuver_time)
        ...
        self.maneuver_velocity = QtWidgets.QLineEdit(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.maneuver_velocity.setFont(font)
        self.maneuver_velocity.setObjectName("maneuver_velocity")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.maneuver_velocity)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Adaptive Kalman Filter"))
        ...
        self.initial_velocity.setText(_translate("MainWindow", "10, 20, 15"))
        ...
        self.n_sigma.setText(_translate("MainWindow", "0.1"))
        self.scale.setText(_translate("MainWindow", "1.0e3"))
        self.label.setText(_translate("MainWindow", "Number of Standard Deviations"))
        self.label_9.setText(_translate("MainWindow", "Scale"))
        self.maneuver_time.setText(_translate("MainWindow", "20.0"))
        self.label_10.setText(_translate("MainWindow", "Maneuver Time"))
        self.maneuver_velocity.setText(_translate("MainWindow", "100, 20, 15"))
        self.label_11.setText(_translate("MainWindow", "Maneuver Velocity"))
