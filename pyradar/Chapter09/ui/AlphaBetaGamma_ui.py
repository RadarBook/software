...
# Form implementation generated from reading ui file 'Chapter09\AlphaBetaGamma.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.noise)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.alpha)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.beta)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.gamma)
        ...
        self.initial_acceleration = QtWidgets.QLineEdit(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.initial_acceleration.setFont(font)
        self.initial_acceleration.setObjectName("initial_acceleration")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.initial_acceleration)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Alpha Beta Gamma Filter"))
        ...
        self.initial_position.setText(_translate("MainWindow", "1.3"))
        ...
        self.alpha.setText(_translate("MainWindow", "0.06"))
        self.label.setText(_translate("MainWindow", "Beta"))
        self.beta.setText(_translate("MainWindow", "0.0018"))
        ...
        self.plot_type.setItemText(2, _translate("MainWindow", "Acceleration"))
        self.plot_type.setItemText(3, _translate("MainWindow", "Residual"))
        self.gamma.setText(_translate("MainWindow", "2.75e-5"))
        self.label_9.setText(_translate("MainWindow", "Gamma"))
        self.initial_acceleration.setText(_translate("MainWindow", "3.0"))
        self.label_10.setText(_translate("MainWindow", "Initial Acceleration (m/s/s)"))
